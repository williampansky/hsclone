...
const Component = styled.div`
  ...
  box-shadow: var(--box-shadow-can-be-debuffed);
  cursor: pointer;
  height: 100%;
  opacity: 0;
  ...
  @keyframes at-ripple-pink {
    0% {
      box-shadow: 0 4px 10px rgba(172, 236, 53, 0.5),
        0 0 0 0 rgba(172, 236, 53, 0.5), 0 0 0 5px rgba(172, 236, 53, 0.5),
        0 0 0 10px rgba(172, 236, 53, 0.5);
    }
    100% {
      box-shadow: 0 4px 10px rgba(172, 236, 53, 0.5),
        0 0 0 5px rgba(172, 236, 53, 0.5), 0 0 0 10px rgba(172, 236, 53, 0.5),
        0 0 0 20px rgba(172, 236, 53, 0);
    }
  }
