...
test(`matches player's current energy with their total`, () => {
  ...
  matchCurrentWithTotalEnergy(G, player);
...
test(`subtract the provided amount from player's current energy value`, () => {
  ...
  subtractFromCurrentEnergy(G, player, 2);
